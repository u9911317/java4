...
public class HashMap01 {
    public static void main(String[] args) {
       ...
       7) HashMapler entry leri rastgele siralar bu yuzden en hizli Map tir
        ...
        countryPopulation.put("Albenia", 18000000);
        System.out.println(countryPopulation);//{USA=40000000, Turkey=83000000, Albenia=3000000, Germany=83000000}
