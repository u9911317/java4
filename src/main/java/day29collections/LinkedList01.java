...
public class LinkedList01 {
    public static void main(String[] args) {
        ...
        // System.out.println(s);//[Nuriye, Orhan, Saadet, Niyazi, Abdullah]
     ...
     */
        ...
        String r2 = s.poll();//ilk node u verir ve lis ten siler (cut + paste)
       ...
       */
        ...
        //note : poll() ile pop()  methodlari ikiside ilk elemnai siler ve size verir(cut+paste) pop hata poll null verir
