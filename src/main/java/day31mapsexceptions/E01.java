...
public class E01 {
   ...
   Java Exception olusturan kod icin bizden karar vermemizi ister
    ...
    //ArithmeticException yazdiginiz kodda matematiksel islem kullaniyorsaniz alinabilcek bir exception dir
    public static void divide2(int a, int b) {
        try {
            System.out.println("try blok ici exception oncesi");
            System.out.println(a / b);
            System.out.println("try blok ici exception sonrasi");
        ...
        public static void divide ( int a, int b){
            if (b == 0) {
                System.out.println("Do not divide by xero");
            } else {
                System.out.println(a / b);
            }
